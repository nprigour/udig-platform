...
public class DatePickerDialog extends Dialog
{
	 ...
	 * @param parent
	 */
	public DatePickerDialog(Shell parent, String subject) {
	 ...
	 * @param parent
	 */
	public DatePickerDialog(Shell parent, String subject, boolean allowNullOPtion) {
		super(parent);
		description = subject;
		setDate(null);
	...
	protected Control createDialogArea(Composite parent) {
		...
		swtCalendar = new DateTime(parent, SWT.DATE | SWT.BORDER);
		...
		if (allowNullOption) {
			...
			unsetDateCheckbox.setLayoutData(new GridData(SWT.LEFT, SWT.TOP, false, false));
		}
		return client;
	}
